...
const ItChat = () => {
  ...
  useEffect(() => {
    ...
    socket.current.on('receiveMessage', msg => {
      ...
      // if open chat, bump and mark seen
                    ...
                    <div className="modern-chat-messages">
                      {loadingMessages
                        ...
                        : messages.map((msg, idx) => {
                            ...
                            const seenByOther = isLastOwn && msg.seen?.length>0;
                            return (
                              <div key={msg._id} className={`modern-message-wrapper ${msg.isOwn?'own':'other'}`}>
                                <div className={`modern-message ${msg.isOwn?'own':'other'}`}>
                                  ...
                                  <div className="modern-message-content">
                                    {msg.content}
                                    {msg.isOwn && seenByOther && <FaCheck className="message-tick"/>}
                                  </div>
